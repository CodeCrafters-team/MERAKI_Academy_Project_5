    ...
    <header className="fixed-top">
          ...
          <div className="container-fluid">
            ...
            <div className="collapse navbar-collapse" id="mainNav">
              <ul className="navbar-nav ms-4 ms-lg-5 me-auto mb-2 mb-lg-0 d-flex gap-3">
                ...
                <li className="nav-item"><a className="nav-link" href="/categories"><b>Courses</b></a></li>
      ...
      {sheetOpen && (
        <>
          ...
          ></div>
          <div
            className={`position-fixed top-0 h-100 bg-white shadow-lg rounded-start animate__animated ${closing ? "animate__slideOutRight" : "animate__slideInRight"}`}
            style={{
              width: "340px",
              zIndex: 1055,
              right: 0,
