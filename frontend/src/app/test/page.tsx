			...
			<div className="col-12">
				<div className="row align-items-center">
					...
					<div className="col-6 col-md-3 text-center order-1">
						<img src="https://eduport.webestica.com/assets/images/element/category-1.svg" alt=""/>
					</div>
					...
					<div className="col-6 col-md-3 text-center order-3">
						<img src="https://eduport.webestica.com/assets/images/element/category-2.svg" alt=""/>
					</div>
